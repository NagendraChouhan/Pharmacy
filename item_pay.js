...
{
	img_item[index].innerHTML='<img src='+a+'.'+exte+' alt="'+a+'" class="item_img"><figure><h3 style="text-align:center;color:white" >'+b+'</h3><h2 style="text-align:center;color:red;">'+c+'</h2></figure><button id="buybtn" onclick="pay_fun('+index+')"><a href="pay.html" style="text-decoration:none;" ><strong>Buy</strong></a></button>';
}
...
function val()
{
	...
	item.innerHTML='<img src='+localStorage.getItem("alt")+'.jpg alt='+localStorage.getItem("alt")+'>'
...
function addressload()
{
	...
	img.innerHTML+='<figure><h3 style="color:black">'+localStorage.getItem("name")+'</h3></figure><img src='+localStorage.getItem("alt")+'.jpg alt='+localStorage.getItem("alt")+'>';
}
